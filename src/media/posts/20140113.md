...
<img src="/iomando-pull.webp" alt="iomando 2.0.1 — pull to refresh" title="We are moving on from pull to refresh, now it all happens smoothly, in real time, no user action required" width="250" height="444" loading="lazy" style="border-radius: var(--spacing-2)" />
