...
<video src="/iomando-pull.mp4" poster="/iomando-pull-poster.jpg" width="250" height="444" autoplay loop muted playsinline aria-label="iomando 2.0.1 — pull to refresh" title="We are moving on from pull to refresh, now it all happens smoothly, in real time, no user action required" style="border-radius: var(--spacing-2)"></video>
