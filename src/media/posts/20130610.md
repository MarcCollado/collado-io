...
![iomando pricing](../images/iomando-pricing.jpg 'An early pricing slide taken from an old catalogue')
...
![Revenue vs. Time](../images/iomando-revenue-time-graph-1.jpg 'Our combined selling price for the first year was lower than the acquisition cost for a given user')
...
![Revenue vs. Time](../images/iomando-revenue-time-graph-2.jpg 'We tweaked the business model in order to account for the sale of the hardware and build a SAAS on top')
