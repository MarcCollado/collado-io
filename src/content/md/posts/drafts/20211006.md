...
- **The third story**: the one an impartial observer would recount — i.e. _you can at least agree that you and the other person see things differently_.
- **Hanlon's razor** and **MRI** (most respectful interpretation): never attribute to malice what can be explained by carelessness.
  - Like **Ockham's razor**, it seeks the most simple explanation.
- **Actor-observer** bias:
  - **Fundamental attribution error**: attributing others' behaviors to their internal (or fundamental) motivations, rather than external factors.
  - **Self-serving bias**: we tend to view the world the opposite way, and always generate self-serving reasons to justify our behavior.
- **Veil of ignorance** (original position): try to put yourself in the other person shoes.
  - **Birth lottery** (portion of your success is due to luck) vs. **just world hypothesis** (you reap what you sow) and victim-blame.
- **Learned helplessness**: stop trying to escape difficult situations because we are used to. It also manifests as believing we are incapable of _fill in the blank_.

### Progress, one funeral at a time

- **Paradigm shift**: new explanations are either ignored or rationalized away.
- **Confirmation bias**: gather and interpret new information to confirm preexisting beliefs.
  - **Backfire effect**: confirmation bias brought to its extreme.
  - **Disconfirmation bias**: impose a stronger burden of proof on ideas you don't want to believe.
- The above can be explained by **cognitive dissonance**: the stress of holding two contradictory beliefs at the same time.

> I never allow myself to have an opinion on anything that I don't know the other side's argument better than they do.

—— Charlie Munger

- Fight confirmation bias and cognitive dissonance by **thinking gray** — avoid binary judgements, be patient, and when possible, delay your decision, keep your options open to gather more information — or **devil's advocate** position.

### Don't trust your gut

- **Intuition**: thinking fast and slow.
- **Proximate cause**: the thing that immediately caused something to happen.
- **Root cause**: the real reason something happened.
  - Use **postmortems** to get to the root cause. Use the **5 Whys** technique, where you keep asking "why" until you reach the root cause.
