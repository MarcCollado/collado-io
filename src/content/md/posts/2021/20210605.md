...
The moment transportation and communication could be disengaged from each other, space was not an inevitable constraint on the movement of information. A continent-wide conversation became possible: the telegraph erased state lines, collapsed regions, and, by wrapping the continent in an information grid, created the possibility of a unified American discourse.
