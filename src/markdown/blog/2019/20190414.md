...
- Goals restrict happiness: first, they foster the idea of [Hedonic treadmill](https://en.wikipedia.org/wiki/Hedonic_treadmill), because you're continuously defering happiness until the next milestone (when I have `X` I'll be happy). Second, it allocates success to the binary resolution of achieving it or not instead of focusing on the process.
...
Master the habit of [showing up](/blog/2018/war-of-art#showing-up) and become the type of person who does `X` (ties back to identity).
