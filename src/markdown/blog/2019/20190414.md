...
To master a habit and make it automatic, start with repetition, not perfection.

In order to master a habit, repetition is the key, it is the frequency that makes the difference.
...
Make it satisfying closes the last stage of the loop and increases the odds of repeating it next time. We are more likely to repeat a behavior when the experience is satisfying.

Animals are constantly focused on the present or near future — they live in an immediate-return environment. Your actions deliver clear and immediate outcomes.
...
Our society is "brand-new", we haven't evolved to truly understand delayed-return environment.
...
Make sure you pick the right metric to measure, when a measure becomes the target, it ceases to be a good measure. Measurement is only useful when it guides you and adds context to a larger picture, not when it consumes you.

### The Habit Contract

We are less likely to repeat a bad habit if it is painful or unsatisfying.

Create a verbal or written contract with yourself that states your commitment with a particular habit and the punishment associated if don't follow through.

We care deeply about what others will think of us. Find then an accountability partner to hold yourself accountable, so you can not only uphold your promises to yourself, but to others as well.
...
Mastery requires practice, but the more we practice, the more boring and routine it becomes. Our interest starts to fade. We got bored of habits because they stop delighting us.

Inevitably, habits will get boring over time, and by nature, we crave for novelty. At the end of the day, successful athletes are the ones who can handle the boredom of training every day, doing the same lifts over and over and over.
